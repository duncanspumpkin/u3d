...
IFXRESULT CIFXPerformanceTimer::QueryInterface(IFXREFIID interfaceId, void** ppInterface)
{
    ...
    if (ppInterface)
    {
        if (interfaceId == IID_IFXPerformanceTimer || interfaceId == IID_IFXUnknown)
        {
...
//---------------------------------------------------------------------------
IFXRESULT IFXAPI_CALLTYPE CIFXPerformanceTimer_Factory(IFXREFIID interfaceId, void** ppInterface)
{
    IFXRESULT result;
