...
IFXRESULT IFXMatrix4x4::CalcTRS(IFXVector3* pTranslation, IFXQuaternion* pRotation, IFXVector3* pScale) const
{
...
IFXRESULT IFXMatrix4x4::Decompose(IFXVector3& translation, IFXMatrix4x4& rotation, IFXVector3& scale) const
{
...
{
    return m[0] * CalcDeterminant3x3(m[5], m[6], m[7], m[9], m[10], m[11], m[13], m[14], m[15])
