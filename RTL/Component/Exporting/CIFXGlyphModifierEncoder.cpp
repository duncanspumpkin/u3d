...
IFXRESULT CIFXGlyphGeneratorEncoder::QueryInterface(IFXREFIID interfaceId, void** ppInterface)
{
    IFXRESULT rc = IFX_OK;
                ...
                if (NULL != pUnk)
                {
                    ...
                    switch (uCommandType)
                    {
                        ...
                        case IFXGlyph2DCommands::IGG_TYPE_MOVETO:
                        {
                            ...
                            IFXCHECKX(pGlyphCommand->QueryInterface(IID_IFXGlyphMoveToBlock, (void**)&pGlyphMoveTo));
                            IFXCHECKX(pGlyphMoveTo->GetData(&fDoubleArray[0], &fDoubleArray[1]));
                        ...
                        case IFXGlyph2DCommands::IGG_TYPE_LINETO:
                        {
                            ...
                            IFXCHECKX(pGlyphCommand->QueryInterface(IID_IFXGlyphLineToBlock, (void**)&pGlyphLineTo));
                            IFXCHECKX(pGlyphLineTo->GetData(&fDoubleArray[0], &fDoubleArray[1]));
                        ...
                        case IFXGlyph2DCommands::IGG_TYPE_CURVETO:
                        {
                            ...
                            IFXCHECKX(pGlyphCommand->QueryInterface(IID_IFXGlyphCurveToBlock, (void**)&pGlyphCurveTo));
                            IFXCHECKX(pGlyphCurveTo->GetData(&fDoubleArray[0], &fDoubleArray[1], &fDoubleArray[2], &fDoubleArray[3], &fDoubleArray[4], &fDoubleArray[5],
                                                             &uTemp)); // not needed.
                        ...
                        case IFXGlyph2DCommands::IGG_TYPE_ENDGLYPH:
                        {
                            ...
                            IFXCHECKX(pGlyphCommand->QueryInterface(IID_IFXGlyphTagBlock, (void**)&pGlyphTag));
                            IFXCHECKX(pGlyphTag->GetData(&fDoubleArray[0], &fDoubleArray[1]));
