...
//***************************************************************************
//
//	CIFXLightNodeEncoder.h
//
//	DESCRIPTION:
//		Declaration of the CIFXLightNodeEncoder.
//		The CIFXLightNodeEncoder contains light node encoding functionality
//		that is used by the write manager.
//
//*****************************************************************************

#ifndef CIFXLIGHTNODEENCODER_H
#define CIFXLIGHTNODEENCODER_H
...
class CIFXLightNodeEncoder : virtual public IFXEncoderX,
                             public CIFXNodeBaseEncoder
{
public:
    // Factory function.
    friend IFXRESULT IFXAPI_CALLTYPE CIFXLightNodeEncoder_Factory(IFXREFIID interfaceId, void** ppInterface);
