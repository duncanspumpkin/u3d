...
IFXRESULT CIFXMaterialResourceEncoder::QueryInterface(IFXREFIID interfaceId, void** ppInterface)
{
    IFXRESULT rc = IFX_OK;
...
void CIFXMaterialResourceEncoder::EncodeX(IFXString& rName, IFXDataBlockQueueX& rDataBlockQueue, F64 units)
{
    ...
    try
    {
        ...
        IFXCHECKX(m_pObject->QueryInterface(IID_IFXMaterialResource, (void**)&pMaterialResource));
