...
IFXRESULT CIFXModelNodeEncoder::QueryInterface(IFXREFIID interfaceId, void** ppInterface)
{
    IFXRESULT rc = IFX_OK;
...
void CIFXModelNodeEncoder::EncodeX(IFXString& rName, IFXDataBlockQueueX& rDataBlockQueue, F64 units)
{
    ...
    try
    {
        ...
        {
            IFXCHECKX(pModelResourcePalette->GetName(uModelResourceIndex, &modelResourceName));
        }
        else
        {
