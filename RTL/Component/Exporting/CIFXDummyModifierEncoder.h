...
//***************************************************************************
//
//	CIFXDummyModifierEncoder.h
//
//	DESCRIPTION:
//		Declaration of the CIFXDummyModifierEncoder.
//		The CIFXDummyModifierEncoder contains CLOD modifier
//		encoding functionality that is used by the write manager.
//
//*****************************************************************************

#ifndef CIFXDummyModifierEENCODER_H__
#define CIFXDummyModifierEENCODER_H__
...
class CIFXDummyModifierEncoder : virtual public IFXEncoderX
{
public:
    // Factory function.
    friend IFXRESULT IFXAPI_CALLTYPE CIFXDummyModifierEncoder_Factory(IFXREFIID interfaceId, void** ppInterface);
...
private:
    // methods
    CIFXDummyModifierEncoder();
    virtual ~CIFXDummyModifierEncoder();
