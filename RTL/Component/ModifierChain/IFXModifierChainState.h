...
public:
    ...
    IFXRESULT Initialize(IFXModifierChainInternal* in_pChain, IFXModifierChainInternal* in_pPrevChain, IFXModifierDataPacketInternal* in_pOverrideDP, U32, IFXDidRegistry* pDidRegistry);
    ...
    IFXRESULT Invalidate(U32 inDataElementIndex, U32 uInModifierIndex);

    IFXRESULT ProcessDependencies(U32 inDataElementIndex, U32 uInModifierIndex);
...
private:
    ...
    IFXRESULT BMDPAddOutputs(U32 in_ModIdx, IFXDID** ppOutputs, U32 uOutputCount, U32* pOutputIndices);

    IFXRESULT BMDPPopulateDataElements(U32 in_ModIdx);

    IFXRESULT BMDPConfigureOutputs(U32 in_ModIdx, U32 uOutputCount, U32* pOutputIndices);

    IFXRESULT BMDPVerifyInputs(U32 ModIdx, IFXModifier* pMod, IFXDID** ppOutputs, U32 NumOutputs);

    /** Adds Outputs to a datapackets.
     */
    IFXRESULT BMDPConsumeElements(U32 in_ModIdx, U32 uOutputIdx, U32 in_UnChangedAttrs);

    IFXRESULT BMDPScheduleInvalidations(U32 in_ModIdx, U32 uOutputIdx, IFXDID* pOutputDid, IFXDID** ppInputs, U32 uInputCount);

    IFXRESULT BMDPSetOutputDeps(U32 in_ModIdx, U32 uOutputIdx, IFXDID* pOutputDid, IFXDID** ppOutputDependencies, U32 uOutputDependencyCount, U32* upOutputDependencyAttrs);
