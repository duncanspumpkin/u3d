...
IFXINLINE void CRedBlackTree<T, K, CMP>::rotateLeft(RBNode* pInNode)
{
    ...
    if (pRightChild->left != m_NIL)
    {
        pRightChild->left->parent = pInNode;
    }
...
IFXINLINE void CRedBlackTree<T, K, CMP>::rotateRight(RBNode* pInNode)
{
    ...
    if (pLeftChild->right != m_NIL)
    {
        pLeftChild->right->parent = pInNode;
    }

    // Establish y->parent link
    if (pLeftChild != m_NIL)
    {
        pLeftChild->parent = pInNode->parent;
    }
