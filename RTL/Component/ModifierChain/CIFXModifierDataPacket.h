                               ...
                               public CIFXSubject
{
    ...
    friend IFXRESULT IFXAPI_CALLTYPE CIFXModifierDataPacket_Factory(IFXREFIID iid, void** ppv);
...
public:
    ...
    IFXRESULT IFXAPI GetDataElementAspectBit(IFXREFGUID rInDataElement, U32& ruOutBitField);

    IFXRESULT IFXAPI GetDataElementIndex(IFXREFGUID rInDataElementGUID, U32& ruOutIndex);
    IFXRESULT IFXAPI GetDataPacketSize(U32& ruOutNumberOfDataElements);
    IFXRESULT IFXAPI GetDataElementGUID(U32 inDataElementIndex, IFXGUID*& rpOutDataElementGUID);
    IFXRESULT IFXAPI GetDataElement(U32 inDataElementIndex, void** ppOutDataElement);
    IFXRESULT IFXAPI GetDataElement(U32 inDataElementIndex, IFXREFIID desiredInterface, void** ppOutDataElement);

    // IFXModifierDataPacket interface
    IFXRESULT IFXAPI GetDataElementChangeCount(U32 inDataElementIndex, U32& uOutChangeCount);
    IFXRESULT IFXAPI InvalidateDataElement(U32 inInvalidDataElementIndex);
    IFXRESULT IFXAPI DataElementIsValid(U32 inDataElementIndex, BOOL& rbOutIsValid);
    ...
    IFXRESULT IFXAPI SetModifierChain(IFXModifierChain*, U32, IFXDataPacketState*);

    IFXRESULT IFXAPI GetDataPacketState(IFXDataPacketState** out_ppState, IFXIntraDependencies**);
