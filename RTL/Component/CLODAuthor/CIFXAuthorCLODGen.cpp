...
IFXRESULT CIFXAuthorCLODGen::QueryInterface(IFXREFIID interfaceId, void** ppInterface)
{
...
IFXRESULT CIFXAuthorCLODGen::Generate(const IFXAuthorCLODGenParam* in_pParams, IFXProgressCallback* in_pProgress, IFXAuthorCLODMesh* in_pMesh, IFXAuthorCLODMesh** out_ppMesh, IFXAuthorMeshMap** out_ppMapping)
{
    IFXRESULT result = IFX_OK;
