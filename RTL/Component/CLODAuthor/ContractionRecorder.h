...
private:
    ...
    U32 recordVerticesInFaceUpdates(SmallPtrSet* updated, IFXAuthorFaceUpdate* faceUpdates, Vertex* keep, Vertex* remove);
    U32 recordTexCoordsInFaceUpdates(FacePtrSet* deleted, SmallPtrSet* updated, IFXAuthorFaceUpdate* faceUpdates, Vertex* keep, Vertex* remove);
    UPTR recordAttributesInFaceUpdates(FacePtrSet* deleted, SmallPtrSet* updated, IFXAuthorFaceUpdate* pFaceUpdate, Vertex* keep, Vertex* remove);

    BOOL fillUpdateRecord(IFXAuthorFace* delFace, IFXAuthorFace* upFace, U32 upFaceIndex, IFXAuthorFaceUpdate::AttributeType attribute, U32 deletedKeepCorner, U32 deletedRemoveCorner, U32 updatedCorner, IFXAuthorFaceUpdate* pFaceUpdate);

    U32 recordNormalsInFaceUpdates(Vertex* keep, SmallPtrSet* faceSet, IFXAuthorFaceUpdate* faceUpdates);
    U32 recordNormalUpdate(U32 faceIndex, U32 keepVertex, U32 normalIndex, IFXAuthorFaceUpdate* faceUpdate);
    ...
    U32 recordNormalsInFaceUpdates_NormalNeighborhood(Vertex* keep, SmallPtrSet* updatedFaces, IFXAuthorFaceUpdate* faceUpdates, BOOL smallNormalChange);
    ...
    U32 recordNormalsInFaceUpdates_CreaseAngle(Vertex* keep, SmallPtrSet* faceSet, float tolerance, IFXAuthorFaceUpdate* faceUpdates);
