...
public:
    ...
    virtual IFXRESULT IFXAPI Allocate(IFXVertexAttributes vaAttribs, U32 uNumVertices, U32 uNumFaces);
    ...
    // this mesh.
    virtual IFXRESULT IFXAPI FastCopy(IFXMesh& rSrcMesh, U32 uStartVertex, U32 uNumVertices, U32 uStartFace, U32 uNumFaces);

    virtual IFXRESULT IFXAPI TransferData(IFXMesh& rSrcMesh, IFXMeshAttributes uTransferAttr, IFXMeshAttributes uCopyAttr);
