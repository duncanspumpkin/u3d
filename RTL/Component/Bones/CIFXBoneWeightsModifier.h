...
public:
    ...
    // IFXModifier
    IFXRESULT IFXAPI GetOutputs(IFXGUID**& rppOutOutputs, U32& rOutNumberOfOutputs, U32*& rpOutOutputDepAttrs);
    ...
    IFXRESULT SetTotalBoneWeightCount(U32 meshIndex, U32 totalVertexCount, U32 totalWeightCount);
    ...
    IFXRESULT SetBoneWeights(U32 vertexIndex, U32 meshIndex, U32 weightCount, U32* pBoneIDs, F32* pBoneWeights);

    IFXRESULT GotoVertex(U32 uVertexIndex, U32 uMeshIndex);

    /// get size of buffers required
    IFXRESULT IFXAPI GetBoneWeightCount(U32 vertexIndex, U32 meshIndex, U32* pWeightCount);
    /// copy RT bone data into given buffers
    IFXRESULT IFXAPI GetBoneWeights(U32 uVertexIndex, U32 uMeshIndex, U32 uWeightCount, U32* puBoneIDs, F32* pfBoneWeights);

    // Bone weight storage methods
    IFXRESULT IFXAPI SetTotalBoneWeightCountForAuthorMesh(U32 totalVertexCount);

    IFXRESULT IFXAPI SetBoneWeightsForAuthorMesh(U32 vertexIndex, U32 weightCount, U32* pBoneIDs, F32* pBoneWeights);
