...
IFXRESULT CIFXSkeleton::SetBoneInfo(U32 uBoneID, IFXBoneInfo* pBoneInfo)
{
    ...
    if (IFXSUCCESS(rc))
    {
        ...
        rot.Active()[0] = (0 != (pBoneInfo->uBoneAttributes & IFXSKELETON_ROTATIONCONSTRAINTACTIVE_X));
        rot.Active()[1] = (0 != (pBoneInfo->uBoneAttributes & IFXSKELETON_ROTATIONCONSTRAINTACTIVE_Y));
        rot.Active()[2] = (0 != (pBoneInfo->uBoneAttributes & IFXSKELETON_ROTATIONCONSTRAINTACTIVE_Z));

        rot.Limited()[0] = (0 != (pBoneInfo->uBoneAttributes & IFXSKELETON_ROTATIONCONSTRAINTLIMITED_X));
        rot.Limited()[1] = (0 != (pBoneInfo->uBoneAttributes & IFXSKELETON_ROTATIONCONSTRAINTLIMITED_Y));
        rot.Limited()[2] = (0 != (pBoneInfo->uBoneAttributes & IFXSKELETON_ROTATIONCONSTRAINTLIMITED_Z));
        ...
        pBoneNode->AutoLink() = (0 == (pBoneInfo->uBoneAttributes & IFXSKELETON_LINKPRESENT));
        pBoneNode->AutoJoint() = (0 == (pBoneInfo->uBoneAttributes & IFXSKELETON_JOINTPRESENT));
    }
