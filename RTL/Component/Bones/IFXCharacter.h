...
typedef void (*IFXDrawLineCB)(I32 color, const IFXVector3& first, const IFXVector3& second);
...
typedef BOOL (*IFXForEachNodeTransformedCB)(IFXCoreNode&, IFXTransform&, IFXVariant state);
...
public:
    ...
    void ForEachNode(I32 flags, IFXForEachNodeCB callback, IFXVariant state = 0);
    void ForEachNodeDual(IFXForEachNodeCB preCallback, IFXForEachNodeCB postCallback, IFXVariant state = 0);
    void ForEachNodeTransformed(I32 flags, IFXForEachNodeTransformedCB callback = NULL, IFXVariant state = 0);
    ...
    static void DrawLine(I32 color, const IFXVector3& first, const IFXVector3& second)
    {
        if (m_drawlineCB)
        {
    ...
    static void TimeProgress(IFXCharacter* character, U32 index, bool on)
    {
        if (m_timeProgressCB)
        {
    ...
    // internal:
    void ForEachNode2(I32 flags, IFXCoreNode& parent, IFXForEachNodeCB callback, IFXVariant state);
    void ForEachNodeDual2(IFXCoreNode& parent, IFXForEachNodeCB preCallback, IFXForEachNodeCB postCallback, IFXVariant state);
    void ForEachNodeTransformed2(I32 flags, IFXCoreNode& parent, IFXForEachNodeTransformedCB callback, IFXVariant state);

private:
    void CopyBoneHierarchy(IFXCoreNode* pParent, IFXCoreNode* pNewParent);
    void CalcNodeRotations(bool lookback, IFXCoreNode& parent);

    IFXCoreNode* FindDescendentByName2(IFXCoreNode& parent, const IFXString& rName);

    static BOOL CreateLinksOnNode(IFXCoreNode& node, IFXVariant state);
    static BOOL RecalcLinksOnNode(IFXCoreNode& node, IFXVariant state);
    static BOOL CalcLinkReferencesOnNode(IFXCoreNode& node, IFXVariant state);
    static BOOL RemoveBoneLinkNode(IFXCoreNode& node, IFXVariant state);
    static BOOL AddBoneToTable(IFXCoreNode& node, IFXVariant state);
    static BOOL BlendBoneNode(IFXCoreNode& node, IFXVariant state);

    static BOOL ResetToReferenceOnNode(IFXCoreNode& node, IFXVariant state);
    static BOOL ResetToFullReachOnNode(IFXCoreNode& node, IFXVariant state);
    static BOOL CountRealBone(IFXCoreNode& node, IFXVariant state);
    static BOOL StoreReferenceForBone(IFXCoreNode& node, IFXTransform& transform, IFXVariant state);
    static BOOL KineBone(IFXCoreNode& node, IFXTransform& transform, IFXVariant state);
    static BOOL StoreIKData(IFXCoreNode& node, IFXVariant state);
    static BOOL CalculateImplantReferenceForBone(IFXCoreNode& node, IFXTransform& transform, IFXVariant state);
