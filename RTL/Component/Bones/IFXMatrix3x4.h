...
public:
    ...
    void TransformVertexAndNormal(const F32 scale, const F32* const vector_in, F32* const vector_out, const F32* const normal_in, F32* const normal_out) const;
    void CumulativeTransformVertexAndNormal(const F32 scale, const F32* const vector_in, F32* const vector_out, const F32* const normal_in, F32* const normal_out) const;
...
IFXINLINE void IFXMatrix3x4::TransformVertexAndNormal(F32 const scale, F32 const* const vi, F32* const vout, F32 const* const ni, F32* const nout) const
{
    // unrolled
#if IFXM34_UNSCALE
