...
private:
    ...
    public:
        ...
        virtual IFXRESULT IFXAPI GetMotion(I32 motionId, IFXMotion** ppMotion, IFXString* pSourcename);
        virtual IFXRESULT IFXAPI PopulateMotionMixer(const IFXString& rMixerName, IFXMotionMixer* pMotionMixer);

        void SetBonesModifier(IFXAnimationModifier* set)
        {
            m_pBonesModifier = set;
        };
        void SetPalettes(IFXPalette* motionPalette, IFXPalette* mixerPalette)
        {
            IFXRELEASE(m_pMotionResourcePalette);
            IFXRELEASE(m_pMixerResourcePalette);
    ...
    private:
        ...
        IFXRESULT MapHierarchy(IFXBonesManager* pBonesManager, IFXMotionMixer* pMotionMixer, U32 motionId, const IFXString& rBoneName);
        IFXRESULT MapConstruct(IFXBonesManager* pBonesManager, IFXMotionMixer* pMotionMixer, IFXMixerConstruct* pMixCon, const IFXString& rBoneName);
