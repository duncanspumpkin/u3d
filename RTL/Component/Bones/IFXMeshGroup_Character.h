...
public:
    ...
    IFXRESULT CleanupWeights(bool regenerate, bool removerogueweights, bool smooth, F32 threshhold, F32 weldmax, F32 modelsize);
    ...
    virtual IFXRESULT IFXAPI GetMasterMeshIndex(U32 mesh, U32 vertex, U32* mesh0, U32* vertex0);
