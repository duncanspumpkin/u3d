...
private:
    ...
    void FloodFill(const IFXArray<IFXMeshVertexMap>& neighbors, const IFXArray<IFXLongListArray>& map, BOOL scanfirst, I32 weightid, I32 newboneid);
    ...
    static BOOL CalculateJointsForBone(IFXCoreNode& node, IFXTransform& transform, IFXVariant state);

    static void CalculateJointForBone(IFXCoreNode& node, IFXTransform& transform, BOOL tip, BOOL computetips);
