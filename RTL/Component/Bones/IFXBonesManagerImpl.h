...
public:
    ...
    virtual IFXRESULT IFXAPI BlendToMotionMixer(IFXMotionMixer* pNext, const IFXBlendParam* pParam);
    ...
    virtual IFXRESULT IFXAPI AddToAutoTranslate(const IFXVector3& addVector, bool last);
    virtual IFXRESULT IFXAPI AddToAutoRotate(const IFXQuaternion& addQuaternion, bool last);
    virtual IFXRESULT IFXAPI AddToAutoScale(const IFXVector3& addVector, bool last);

    virtual IFXRESULT IFXAPI GetMotionMixer(U32 index, IFXMotionMixer** ppMotionMixer)
    {
        IFXRESULT res = IFX_OK;
