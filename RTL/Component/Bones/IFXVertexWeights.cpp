...
{
    qsort(Collect(), GetNumberElements(), sizeof(IFXVertexWeight), &IFXVertexWeights::CompareOnMeshThenVertex);
...
{
    qsort(Collect(), GetNumberElements(), sizeof(IFXVertexWeight), &IFXVertexWeights::CompareOnMeshThenBonesThenVertex);
