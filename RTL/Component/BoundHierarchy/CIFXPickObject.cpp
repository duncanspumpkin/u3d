...
void CIFXPickObject::GetVertices(IFXVector3& v1, IFXVector3& v2, IFXVector3& v3)
{
    v1 = m_vTriVerts[0];
    v2 = m_vTriVerts[1];
    v3 = m_vTriVerts[2];
...
void CIFXPickObject::SetVertices(IFXVector3& v1, IFXVector3& v2, IFXVector3& v3)
...
void CIFXPickObject::SetUVTCoords(F32 fU, F32 fV, F32 fDistance)
{
    m_bComputed = FALSE;
