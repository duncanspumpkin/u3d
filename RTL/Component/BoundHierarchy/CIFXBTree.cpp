...
IFXRESULT CIFXBTree::IntersectRayTraverse(CIFXBTreeNode* pNode, IFXVector3& vOrigin, IFXVector3& vDirection, U32 uPickType)
{
...
IFXRESULT CIFXBTree::IntersectTraverseQuick(CIFXBTreeNode* pNodeA, CIFXBTreeNode* pNodeB, IFXVector3 vMin[2], IFXVector3 vMax[2])
{
    IFXRESULT result = IFX_OK;
...
IFXRESULT CIFXBTree::IntersectBoxSphere(CIFXBTreeNode* pNodeA, CIFXBTreeNode* pNodeB, F32 fRadiusSquared, IFXVector3& vSphereCentroid, IFXVector3& vContactPoint, IFXVector3 vContactNormal[2])
{
    IFXRESULT result = IFX_OK;
    ...
    if (pNodeA && pNodeB)
    {
        ...
        if (pBoundA && pBoundB)
        {
            ...
            result = pBox->IntersectBoxSphere(pBoundB, fRadiusSquared, vSphereCentroid, vContactPoint, vContactNormal);
        }
        else
        {
            result = IFX_E_INVALID_POINTER;
