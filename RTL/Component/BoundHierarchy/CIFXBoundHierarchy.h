...
public:
    ...
    IFXRESULT IFXAPI GetCollisionResultPointer(U32 uModelIndex, CIFXCollisionResult** ppResultPointer);

    IFXRESULT IFXAPI GetFaceCounts(U32** puFaceCounts);

    void IFXAPI GetMatrixComponents(U32 uIndex, IFXVector3& mTranslation, IFXVector3& mScaleFactor, IFXMatrix4x4& mTargetMatrix);

    IFXRESULT IFXAPI GetPositionCounts(U32** puPositionCounts);

    IFXRESULT IFXAPI GetRoot(CIFXBTreeNode** ppRoot);

    void IFXAPI GetScaleFactor(U32 uIndex, IFXVector3& vScaleFactor);

    void IFXAPI GetTransposeMatrix(U32 uIndex, IFXMatrix4x4& mTransposeMatrix);

    void IFXAPI GetWorldMatrix(U32 uIndex, IFXMatrix4x4& mWorldMatrix);

    IFXRESULT IFXAPI InitHierarchy(IFXMeshGroup* pMeshGroup, IFXVector3** ppVertexList);

    IFXRESULT IFXAPI IntersectBoxSphere(IFXBoundHierarchy* pHierarchy, F32 fRadiusSquared, IFXVector3& vSphereCentroid, IFXVector3& vContactPoint, IFXVector3 vContactNormal[2]);

    IFXRESULT IFXAPI IntersectHierarchy(IFXBoundHierarchy* pHierarchy);

    IFXRESULT IFXAPI IntersectHierarchyQuick(IFXBoundHierarchy* pHierarchy, IFXVector3 vMin[2], IFXVector3 vMax[2]);

    IFXRESULT IFXAPI IntersectRay(IFXVector3& vOrigin, IFXVector3& vDirection, U32 uPickType, CIFXCollisionResult** ppResultPointer);

    void IFXAPI SetMatrix(U32 uIndex, IFXMatrix4x4& mMatrix, IFXVector3& vScale);

    IFXRESULT IFXAPI SetResult(U32 uModelIndex, U32 uMeshID, U32 uFaceID, IFXVector3& vIntersectPoint, IFXVector3& vIntersectNormal);

    IFXRESULT IFXAPI SetResult(U32 uMeshID, U32 uFaceID, IFXVector3 vVerts[3], F32 fU, F32 fV, F32 fT);
