...
private:
    ...
    IFXRESULT IFXAPI_CALLTYPE MipMap(STextureOutputInfo* pSrcOutputInfo, STextureOutputInfo* pDstOutputInfo, U32 uSrcX, U32 uSrcY, U32 uDstX, U32 uDstY);

    IFXRESULT IFXAPI_CALLTYPE ReformatImage(U8* pDst, IFXenum pSrcFormat, IFXenum eSrcOrder, IFXenum pDstFormat, IFXenum eDstOrder, U32 uSrcX, U32 uSrcY, U32 uSrcPitch, U32 uDstX, U32 uDstY, U32 uDstPitch, U32 uWidth, U32 uHeight);
