...
private:
    ...
    IFXRESULT CompressImage(void* pSourceImage, STextureSourceInfo* pImageInfo, U32& continuationIndex, void** ppCompressedData);

    IFXRESULT DecompressImage(void* pCompressedData, STextureSourceInfo* pImageInfo, U32& continuationIndex, void** ppDecompressedImage);
    ...
    // Jpeg routines
    IFXRESULT CompressImageJPEG(void* pSourceImage, STextureSourceInfo* pImageInfo, U32& continuationIndex, void** ppCompressedData);
    IFXRESULT DecompressImageJPEG(void* pCompressedData, STextureSourceInfo* pImageInfo, U32& continuationIndex, void** ppDecompressedImage);

    // PNG routines
    IFXRESULT CompressImagePng(void* pSourceImage, STextureSourceInfo* pImageInfo, U32& continuationIndex, void** ppCompressedData);
    IFXRESULT DecompressImagePng(void* pCompressedData, STextureSourceInfo* pImageInfo, U32& continuationIndex, void** ppDecompressedImage);
