...
U32 CIFXBTTHash::m_uDefaultBlockTypeCount = sizeof(CIFXBTTHash::m_DefaultBlockTypes) / sizeof(IFXBTTHash::IFXBTTHashEntry);
...
//---------------------------------------------------------------------------
IFXRESULT IFXAPI_CALLTYPE CIFXBTTHash_Factory(IFXREFIID interfaceId, void** ppInterface)
{
    IFXRESULT rc = IFX_OK;
...
//---------------------------------------------------------------------------
IFXRESULT CIFXBTTHash::QueryInterface(IFXREFIID interfaceId, void** ppInterface)
{
    IFXRESULT rc = IFX_OK;
...
//-------------------------------------------------------------------
IFXINLINE IFXRESULT CIFXBTTHash::Initialize(U32 uHashSize, U32 numEntries, const IFXBTTHashEntry* pEntryList)
{
    IFXRESULT rc = IFX_OK;
    U32 i = 0;
...
//-------------------------------------------------------------------
IFXINLINE IFXRESULT CIFXBTTHash::Find(U32 uKey, IFXBTTHashEntry* pEntry)
{
    IFXRESULT rc = IFX_OK;
    IFXHashU32Link* pHashLink = NULL;
    IFXHashU32Link* pPrvHashLink = NULL;
