...
IFXRESULT IFXVectorHasher::Initialize(U32 numVectors, IFXVector3* pMin, IFXVector3* pMax)
{
...
IFXRESULT IFXVectorHasher::AddVector(IFXVector3* pVector, U32 meshIndex, U32 vertexIndex)
{
...
IFXRESULT IFXVectorHasher::AddVectorNode(IFXVectorHasherVectorNode** ppFront, U32 meshIndex, U32 index)
{
    IFXRESULT result = IFX_OK;
