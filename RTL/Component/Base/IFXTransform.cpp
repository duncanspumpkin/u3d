...
BOOL IFXTransform::Interpolate(F32 t, IFXTransform& rFrom, IFXTransform& rTo)
{
    ...
    translation.Interpolate(t, IFXVector3(&rFrom.m_matrix[12]), IFXVector3(&rTo.m_matrix[12]));
    m_scale.Interpolate(t, rFrom.m_scale, rTo.m_scale);
    m_quaternion.Interpolate(t, rFrom.QuaternionConst(), rTo.QuaternionConst());
...
IFXRESULT IFXTransform::CalcTRS(IFXVector3* pTranslation, IFXQuaternion* pRotation, IFXVector3* pScale)
{
...
void IFXTransform::MakeTRS(const IFXVector3& rTranslation, const IFXQuaternion& rRotation, const IFXVector3& rScale)
{
...
void IFXTransform::ReverseRotateVectorByQuat(const F32* pSource, IFXVector3& rResult)
{
