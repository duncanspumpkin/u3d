...
public:
    void Reset();
    void PointAt(U32 uIndex, IFXTQTVertex* pVertex, IFXTQTTriangle* pTriangle = NULL, IFXTQTAddress* pAddress = NULL, IFXTQTAddress::Direction uDirection = IFXTQTAddress::UnDefined, IFXTQTLocality locality = UndefinedTriangle);
...
private:
    ...
    void CheckForDiscontinuities(U32 uIndex, IFXTQTTriangle* pTriangle, IFXTQTAddress::Direction uReOreintedDirection);
};
...
IFXINLINE void IFXAttributeNeighborhood::PointAt(U32 uIndex, IFXTQTVertex* pVertex, IFXTQTTriangle* pTriangle, IFXTQTAddress* pAddress, IFXTQTAddress::Direction uReOreintedDirection, IFXTQTLocality locality)
{
    if (pVertex)
    {
...
IFXINLINE IFXTQTAddress::Direction IFXAttributeNeighborhood::ReOrient(U32 uIndex, IFXTQTAddress::Direction uDirection)
{
