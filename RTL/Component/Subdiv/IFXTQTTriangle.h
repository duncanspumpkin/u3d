...
public:
    ...
    void Init(IFXTQTBaseTriangle* pBaseTriangle, IFXTQTTriangle* pParentTriangle, IFXTQTAddress address, SametOrientation sametOrient, IFXTQTVertex* pLeftVertex, IFXTQTVertex* pBaseVertex, IFXTQTVertex* pRightVertex);
    void SetVertices(IFXTQTVertex* pLeftVertex, IFXTQTVertex* pBaseVertex, IFXTQTVertex* pRightVertex);
    ...
    // Crack fill support:
    void AddCrackFillData(IFXSubdivisionManager* pSubdivMgr, IFXTQTAddress::Direction, IFXTQTVertex* pCrackVertex, BOOL bDiscontinuity);
    ...
    // Accessors:
    IFXTQTLocality GetSubdivNeighbor(IFXSubdivisionManager* pSubdivMgr, IFXTQTAddress::Direction usDirection, IFXAttributeNeighborhood* pNeighHood, U32 uIndex);
    BOOL ChildrenActive();

    IFXTQTTriangle* GetChildTriangle(U32 uIndex);
    void GetMidPoint(IFXTQTAddress::Direction usDirection, IFXTQTVertex** ppVertex);
...
protected:
    ...
    void Reset();
    IFXTQTLocality LocateNeighborTriangle(IFXTQTAddress::Direction usDirection, IFXTQTAddress* pNeighAddr, IFXTQTTriangle** ppNeighbor, IFXTQTAddress::Direction* pOrientation);
...
IFXINLINE void IFXTQTTriangle::Init(IFXTQTBaseTriangle* pBaseTriangle, IFXTQTTriangle* pParentTriangle, IFXTQTAddress address, SametOrientation sametOrient, IFXTQTVertex* pLeftVertex, IFXTQTVertex* pBaseVertex, IFXTQTVertex* pRightVertex)
{
...
IFXINLINE void IFXTQTTriangle::GetMidPoint(IFXTQTAddress::Direction usDirection, IFXTQTVertex** ppVertex)
{
    *ppVertex = NULL;
