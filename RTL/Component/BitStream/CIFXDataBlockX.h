...
class CIFXDataBlockX : public IFXDataBlock, public IFXReadBuffer, public IFXWriteBuffer, public IFXDataBlockX, public IFXReadBufferX, public IFXWriteBufferX
{
public:
    ...
    // Factory function.
    friend IFXRESULT IFXAPI_CALLTYPE CIFXDataBlockX_Factory(IFXREFIID interfaceId, void** ppInterface);
