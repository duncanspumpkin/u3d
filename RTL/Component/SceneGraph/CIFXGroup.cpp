...
void CIFXGroup::Counter(EIFXNodeCounterType type, U32* pOutCount)
{
    if (pOutCount)
    {
        ...
        if ((type == IFX_NODE_COUNTER_NODES) || (type == IFX_NODE_COUNTER_GROUPS))
        {
            (*pOutCount)++;
        }
    }
...
IFXRESULT CIFXGroup::GetOutputs(IFXGUID**& rpOutOutputs, U32& rOutNumberOfOutputs, U32*& rpOutOutputDepAttrs)
{
...
IFXRESULT CIFXGroup::GetDependencies(IFXGUID* pInOutputDID, IFXGUID**& rppOutInputDependencies, U32& rOutNumberInputDependencies, IFXGUID**& rppOutOutputDependencies, U32& rOutNumberOfOutputDependencies, U32*& rpOutOutputDepAttrs)
{
    IFXRESULT result = IFX_OK;
...
IFXRESULT CIFXGroup::GenerateOutput(U32 inOutputDataElementIndex, void*& rpOutData, BOOL& rNeedRelease)
{
    IFXRESULT result = IFX_OK;
...
IFXRESULT CIFXGroup::Notify(IFXModifierMessage eInMessage, void* pMessageContext)
{
    return IFX_OK;
}
