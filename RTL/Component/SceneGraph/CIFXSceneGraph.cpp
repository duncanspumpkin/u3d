...
IFXRESULT CIFXSceneGraph::Initialize(IFXCoreServices* pCS)
{
    ...
    for (; uPaletteIndex < NUMBER_OF_PALETTES; uPaletteIndex++)
    {
        ...
        result = IFXCreateComponent(CID_IFXPalette, IID_IFXPalette, (void**)&(m_pPalettes[uPaletteIndex]));
    ...
    IFXCreateComponent(CID_IFXMaterialResource, IID_IFXUnknown, (void**)&pUnknown);
    ...
    IFXCreateComponent(CID_IFXAuthorCLODResource, IID_IFXModifier, (void**)&pMod2);
    IFXAuthorCLODResource* pAuthorCLODResource = NULL;
    pMod2->QueryInterface(IID_IFXAuthorCLODResource, (void**)&pAuthorCLODResource);
    pAuthorCLODResource->SetSceneGraph((IFXSceneGraph*)this);
    IFXAuthorCLODMesh* pMesh = NULL;
    IFXCreateComponent(CID_IFXAuthorMesh, IID_IFXAuthorCLODMesh, (void**)&pMesh);
    ...
    IFXCreateComponent(CID_IFXShaderLitTexture, IID_IFXUnknown, (void**)&pUnknown);
    {
        IFXShaderLitTexture* pShaderLitTexture = NULL;
        pUnknown->QueryInterface(IID_IFXShaderLitTexture, (void**)&pShaderLitTexture);
    ...
    IFXCreateComponent(CID_IFXMotionResource, IID_IFXUnknown, (void**)&pUnknown);
    {
        IFXMotionResource* pMotionResource = NULL;
        pUnknown->QueryInterface(IID_IFXMotionResource, (void**)&pMotionResource);
    ...
    IFXCreateComponent(CID_IFXMixerConstruct, IID_IFXUnknown, (void**)&pUnknown);
    {
        IFXMixerConstruct* pMixer = NULL;
        pUnknown->QueryInterface(IID_IFXMixerConstruct, (void**)&pMixer);
    ...
    IFXCreateComponent(CID_IFXTextureObject, IID_IFXTextureObject, (void**)&pTextureObject);
    ...
    IFXCreateComponent(CID_IFXLightResource, IID_IFXUnknown, (void**)&pUnknown);
    {
        IFXLightResource* pLightResource = NULL;
        pUnknown->QueryInterface(IID_IFXLightResource, (void**)&pLightResource);
    ...
    IFXCreateComponent(CID_IFXViewResource, IID_IFXUnknown, (void**)&pUnknown);
    {
        IFXDECLARELOCAL(IFXViewResource, pViewResource);

        pUnknown->QueryInterface(IID_IFXViewResource, (void**)&pViewResource);
        ...
        for (uPaletteIndex = 0; uPaletteIndex < NUMBER_OF_PALETTES; uPaletteIndex++)
        {
            if (m_pPalettes[uPaletteIndex] != NULL)
            {
                ...
                while (IFXSUCCESS(rc))
                {
                    ...
                    rc = m_pPalettes[uPaletteIndex]->GetResourcePtr(uID, IID_IFXMarker, (void**)&pMarker);
...
IFXRESULT CIFXSceneGraph::GetPalette(EIFXPalette eInPalette, IFXPalette** ppOutPalette)
{
    IFXRESULT result = IFX_E_UNDEFINED;
