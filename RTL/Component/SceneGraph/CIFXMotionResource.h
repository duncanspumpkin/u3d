...
public:
    ...
    virtual IFXRESULT IFXAPI FilterAndCompress(F32 deltatime = 0.01f, F32 deltalocation = 0.01f, F32 deltarotation = 0.001f, F32 deltascale = 0.01f);
    ...
    virtual IFXRESULT IFXAPI GetKeyFrames(U32 uTrackID, U32 uKeyFrameStart, U32 uKeyFrameCount, IFXKeyFrame* pKeyFrameArray);
...
private:
    ...
    friend IFXRESULT IFXAPI_CALLTYPE CIFXMotionResource_Factory(IFXREFIID interfaceId, void** ppInterface);
    // IFXUnknown
    U32 m_refCount;
