...
IFXRESULT IFXAPI_CALLTYPE CIFXSimpleCollection_Factory(IFXREFIID interfaceId, void** ppInterface)
{
    IFXRESULT result;
...
IFXRESULT CIFXSimpleCollection::QueryInterface(IFXREFIID interfaceId, void** ppInterface)
{
            ...
            < (m_uSpatials[(U32)eInType] + uInNumberOfSpatials))
        {
            ...
            { // Reallocate
                m_pSpatials[(U32)eInType] = (IFXSpatial**)
                    IFXReallocate(m_pSpatials[(U32)eInType], (m_uSpatials[(U32)eInType] + uInNumberOfSpatials + m_allocationPad) * sizeof(IFXSpatial*));
            ...
            {
                m_pSpatials[(U32)eInType] = (IFXSpatial**)
                    IFXAllocate((uInNumberOfSpatials + m_allocationPad) * sizeof(IFXSpatial*));
    ...
    IFXSpatial::eType eInType)
{
    ...
    for (i = 0; i < uInNumberOfSpatials; i++)
    {
        ...
        for (e = m_uSpatials[uType]; e--;)
        {
            ...
            {
                (m_pSpatials[uType])[e] = (m_pSpatials[uType])[--m_uSpatials[uType]];
                break;
            }
        }
    }
