...
IFXRESULT CIFXDummyModifier::QueryInterface(IFXREFIID interfaceId, void** ppInterface)
{
...
IFXRESULT CIFXDummyModifier::GetOutputs(IFXGUID**& rpOutOutputs, U32& rOutNumberOfOutputs, U32*& rpOutOutputDepAttrs)
{
...
IFXRESULT CIFXDummyModifier::GenerateOutput(U32 inOutputDataElementIndex, void*& rpOutData, BOOL& rNeedRelease)
{
    IFXRESULT result = IFX_OK;
...
IFXRESULT CIFXDummyModifier::Notify(IFXModifierMessage eInMessage, void* pMessageContext)
