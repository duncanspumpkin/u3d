...
public:
    ...
    IFXRESULT IFXAPI GetAssociatedSpatial(U32 uInSpatialIndex, IFXSpatial** ppOutSpatial, IFXSpatialAssociation::Type eInAssociationType);
    IFXRESULT IFXAPI SetAssociatedSpatials(SPATIALINSTANCE_LIST* pInSpatials, U32 uInSpatialCount, IFXSpatialAssociation::Type eInAssociationType);
    IFXRESULT IFXAPI AppendAssociatedSpatials(SPATIALINSTANCE_LIST* pInSpatials, U32 uInSpatialCount, IFXSpatialAssociation::Type eInAssociationType);
    // IFXObserver
