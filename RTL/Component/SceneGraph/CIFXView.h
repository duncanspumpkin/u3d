                 ...
                 virtual public IFXView
{
    CIFXView();
    virtual ~CIFXView();
    friend IFXRESULT IFXAPI_CALLTYPE CIFXView_Factory(IFXREFIID riid, void** ppv);
...
public:
    ...
    using CIFXNode::Pick;
    IFXRESULT IFXAPI Pick(F32 x, F32 y, U32 ViewInstance, IFXModel** ppOutPickedModel, U32* pInstance);
    IFXRESULT IFXAPI PickMultiple(F32 x, F32 y, U32 ViewInstance, IFXSimpleList** ppOutPickedObjectList);
    IFXRESULT IFXAPI WindowToFilm(F32 x, F32 y, IFXVector3* pvOutFilmPt);
    IFXRESULT IFXAPI FrustumToWindow(const IFXVector3* pvcVector, I32* const picX, I32* const picY) const;
