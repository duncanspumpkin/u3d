...
IFXRESULT CIFXViewResource::SetNumRenderPasses(U32 uNumPasses)
{
    ...
    IFXASSERTBOX(uNumPasses <= 32, "Trying to use too many rendering passes - use less than 33");
...
IFXRESULT CIFXViewResource::SetCurrentRenderPass(U32 uRenderPass)
{
    ...
    IFXASSERTBOX(uRenderPass < m_uNumRenderPasses, "Setting invalid render pass number");
