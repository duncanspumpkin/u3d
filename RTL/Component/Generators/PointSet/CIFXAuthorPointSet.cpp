    ...
    const IFXAuthorPointSetDesc* pPointSetDesc)
{
    ...
    else if (pPointSetDesc->m_numPoints > m_MaxPointSetDesc.m_numPoints || pPointSetDesc->m_numPositions > m_MaxPointSetDesc.m_numPositions || pPointSetDesc->m_numNormals > m_MaxPointSetDesc.m_numNormals || pPointSetDesc->m_numDiffuseColors > m_MaxPointSetDesc.m_numDiffuseColors || pPointSetDesc->m_numSpecularColors > m_MaxPointSetDesc.m_numSpecularColors || pPointSetDesc->m_numTexCoords > m_MaxPointSetDesc.m_numTexCoords || pPointSetDesc->m_numMaterials != m_MaxPointSetDesc.m_numMaterials)
    {
...
IFXRESULT CIFXAuthorPointSet::Reallocate(const IFXAuthorPointSetDesc* pPointSetDesc)
{
    ...
    if (IFXSUCCESS(ir) && m_MaxPointSetDesc.m_numPositions != pPointSetDesc->m_numPositions)
    {
        ReallocDataBlock(
            m_pPositions,
    ...
    if (IFXSUCCESS(ir) && m_MaxPointSetDesc.m_numNormals != pPointSetDesc->m_numNormals)
    {
        ReallocDataBlock(
            m_pNormals,
    ...
    if (IFXSUCCESS(ir) && m_MaxPointSetDesc.m_numDiffuseColors != pPointSetDesc->m_numDiffuseColors)
    {
        ReallocDataBlock(
            m_pDiffuseColors,
    ...
    if (IFXSUCCESS(ir) && m_MaxPointSetDesc.m_numSpecularColors != pPointSetDesc->m_numSpecularColors)
    {
        ReallocDataBlock(
            m_pSpecularColors,
    ...
    if (IFXSUCCESS(ir) && m_MaxPointSetDesc.m_numTexCoords != pPointSetDesc->m_numTexCoords)
    {
        ReallocDataBlock(
            m_pTexCoords,
    ...
    if (IFXSUCCESS(ir) && m_MaxPointSetDesc.m_numMaterials != pPointSetDesc->m_numMaterials)
    {
        ReallocDataBlock(
            m_pMaterials,
...
IFXRESULT CIFXAuthorPointSet::GetTexPoints(U32 index, U32** ppTexPoints)
{
    ...
    if (IFXSUCCESS(ir) && m_pTexCoordPoints[index].IsNull())
    {
        ...
        {
            memset(m_pTexCoordPoints[index], 0, m_MaxPointSetDesc.m_numPoints * sizeof(U32));
        }
    }
...
IFXRESULT CIFXAuthorPointSet::SetTexPoint(U32 in_Layer, U32 index, const U32* pPoint)
{
    IFXRESULT ir = IFX_OK;
