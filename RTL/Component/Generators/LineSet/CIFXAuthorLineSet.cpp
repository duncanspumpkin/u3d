...
IFXRESULT CIFXAuthorLineSet::GetTexLines(U32 index, IFXU32Line** ppTexLines)
{
    ...
    if (IFXSUCCESS(ir) && m_pTexCoordLines[index].IsNull())
    {
        ...
        {
            memset(m_pTexCoordLines[index], 0, m_MaxLineSetDesc.m_numLines * sizeof(IFXU32Line));
        }
    }
...
IFXRESULT CIFXAuthorLineSet::GetTexLine(U32 layer, U32 index, IFXU32Line* pLine)
{
    IFXRESULT ir = IFX_OK;
...
IFXRESULT CIFXAuthorLineSet::SetTexLine(U32 layer, U32 index, const IFXU32Line* pLine)
{
    IFXRESULT ir = IFX_OK;
