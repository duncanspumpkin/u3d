...
public:
    ...
    virtual IFXRESULT IFXAPI InitCompile(IFXAuthorCLODMesh*, U32 numOutputSizes, IFXMeshSize* OutputSizeArray);
...
private:
    ...
    IFXRESULT findOrBuildVertex(U32 authorFaceCorner, U32 authorFaceIndex, U32 mat, IFXResolutionChange* pRC, U32* pOutIFXVertexIndex);
