...
IFXRESULT CIFXNameMap::NewScope(U32 uScopeId, IFXCollisionPolicy uPolicy)
{
    ...
    if ((uPolicy != IFXCOLLISIONPOLICY_DISCARD) && (uPolicy != IFXCOLLISIONPOLICY_REPLACE) && (uPolicy != IFXCOLLISIONPOLICY_PREPENDALL) && (uPolicy != IFXCOLLISIONPOLICY_PREPENDCOLLIDED) && (uPolicy != IFXCOLLISIONPOLICY_POSTMANGLE))
    {
        rc = IFX_E_BAD_PARAM;
    }
