/**
        ...
        @note	This file and predicates.h were derived from the file called
        ...
        @note	Most of the comments in the file are the same as the original.
                        For additional documentation please refer to those comments and
...
// Turn on optimization to improve floating-point consistency.
#pragma optimize("", off)
#pragma optimize("p", on)
// Turn off warning for conversion of double to float.
...
static REAL *bc = NULL, *ca = NULL, *ab = NULL;
static REAL *axbc = NULL, *axxbc = NULL, *aybc = NULL, *ayybc = NULL, *adet = NULL;
static REAL *bxca = NULL, *bxxca = NULL, *byca = NULL, *byyca = NULL, *bdet = NULL;
static REAL *cxab = NULL, *cxxab = NULL, *cyab = NULL, *cyyab = NULL, *cdet = NULL;
static REAL* abdet = NULL;

static REAL* fin1 = NULL;
static REAL* fin2 = NULL;

static REAL *aa = NULL, *bb = NULL, *cc = NULL;
static REAL *u = NULL, *v = NULL;
static REAL *temp8 = NULL, *temp16a = NULL, *temp16b = NULL, *temp16c = NULL;
static REAL *temp32a = NULL, *temp32b = NULL, *temp48 = NULL, *temp64 = NULL;
static REAL *axtbb = NULL, *axtcc = NULL, *aytbb = NULL, *aytcc = NULL;
static REAL *bxtaa = NULL, *bxtcc = NULL, *bytaa = NULL, *bytcc = NULL;
static REAL *cxtaa = NULL, *cxtbb = NULL, *cytaa = NULL, *cytbb = NULL;
static REAL *axtbc = NULL, *aytbc = NULL, *bxtca = NULL, *bytca = NULL, *cxtab = NULL, *cytab = NULL;
static REAL *axtbct = NULL, *aytbct = NULL, *bxtcat = NULL, *bytcat = NULL, *cxtabt = NULL, *cytabt = NULL;
static REAL *axtbctt = NULL, *aytbctt = NULL, *bxtcatt = NULL;
static REAL *bytcatt = NULL, *cxtabtt = NULL, *cytabtt = NULL;
static REAL *abt = NULL, *bct = NULL, *cat = NULL;
static REAL *abtt = NULL, *bctt = NULL, *catt = NULL;
...
void exactcleanup()
{
    ...
    IFXDELETE_ARRAY(ca);
    IFXDELETE_ARRAY(ab);
    IFXDELETE_ARRAY(axbc);
    IFXDELETE_ARRAY(axxbc);
    IFXDELETE_ARRAY(aybc);
    IFXDELETE_ARRAY(ayybc);
    IFXDELETE_ARRAY(adet);
    IFXDELETE_ARRAY(bxca);
    IFXDELETE_ARRAY(bxxca);
    IFXDELETE_ARRAY(byca);
    IFXDELETE_ARRAY(byyca);
    IFXDELETE_ARRAY(bdet);
    IFXDELETE_ARRAY(cxab);
    IFXDELETE_ARRAY(cxxab);
    IFXDELETE_ARRAY(cyab);
    IFXDELETE_ARRAY(cyyab);
    IFXDELETE_ARRAY(cdet);
    IFXDELETE_ARRAY(abdet);
    IFXDELETE_ARRAY(fin1);
    IFXDELETE_ARRAY(fin2);
    IFXDELETE_ARRAY(aa);
    IFXDELETE_ARRAY(bb);
    IFXDELETE_ARRAY(cc);
    IFXDELETE_ARRAY(u);
    IFXDELETE_ARRAY(v);
    IFXDELETE_ARRAY(temp8);
    IFXDELETE_ARRAY(temp16a);
    IFXDELETE_ARRAY(temp16b);
    IFXDELETE_ARRAY(temp16c);
    IFXDELETE_ARRAY(temp32a);
    IFXDELETE_ARRAY(temp32b);
    IFXDELETE_ARRAY(temp48);
    IFXDELETE_ARRAY(temp64);
    IFXDELETE_ARRAY(axtbb);
    IFXDELETE_ARRAY(axtcc);
    IFXDELETE_ARRAY(aytbb);
    IFXDELETE_ARRAY(aytcc);
    IFXDELETE_ARRAY(bxtaa);
    IFXDELETE_ARRAY(bxtcc);
    IFXDELETE_ARRAY(bytaa);
    IFXDELETE_ARRAY(bytcc);
    IFXDELETE_ARRAY(cxtaa);
    IFXDELETE_ARRAY(cxtbb);
    IFXDELETE_ARRAY(cytaa);
    IFXDELETE_ARRAY(cytbb);
    IFXDELETE_ARRAY(axtbc);
    IFXDELETE_ARRAY(aytbc);
    IFXDELETE_ARRAY(bxtca);
    IFXDELETE_ARRAY(bytca);
    IFXDELETE_ARRAY(cxtab);
    IFXDELETE_ARRAY(cytab);
    IFXDELETE_ARRAY(axtbct);
    IFXDELETE_ARRAY(aytbct);
    IFXDELETE_ARRAY(bxtcat);
    IFXDELETE_ARRAY(bytcat);
    IFXDELETE_ARRAY(cxtabt);
    IFXDELETE_ARRAY(cytabt);
    IFXDELETE_ARRAY(axtbctt);
    IFXDELETE_ARRAY(aytbctt);
    IFXDELETE_ARRAY(bxtcatt);
    IFXDELETE_ARRAY(bytcatt);
    IFXDELETE_ARRAY(cxtabtt);
    IFXDELETE_ARRAY(cytabtt);
    IFXDELETE_ARRAY(abt);
    IFXDELETE_ARRAY(bct);
    IFXDELETE_ARRAY(cat);
    IFXDELETE_ARRAY(abtt);
    IFXDELETE_ARRAY(bctt);
    IFXDELETE_ARRAY(catt);
}
...
static int grow_expansion_zeroelim
(
/* e and h can be the same. */
int elen,
REAL *e,
...
static int expansion_sum_zeroelim1
(
/* e and h can be the same, but f and h cannot. */
int elen,
REAL *e,
...
static int expansion_sum_zeroelim2
(
/* e and h can be the same, but f and h cannot. */
int elen,
REAL *e,
...
static int linear_expansion_sum
(
/* h cannot be e or f. */
int elen,
REAL *e,
...
static int linear_expansion_sum_zeroelim
(
/* h cannot be e or f. */
int elen,
REAL *e,
...
static int scale_expansion_zeroelim(
    /* e and h cannot be the same. */
    int elen,
    REAL* e,
    REAL b,
...
#ifdef ALTERNATIVE_INCIRCLE

static REAL incirclefast(
    REAL* pa,
    REAL* pb,
    REAL* pc,
    REAL* pd)
    ...
    REAL* pd)
{
    ...
    REAL y1[128], y2[192];
    int y1len, y2len;
    REAL adet[384], bdet[384], cdet[384], abdet[768];

    // mac does not have enough stack for deter
    REAL deter[1152];
...
#endif // ALTERNATIVE_INCIRCLE

static REAL incircleadapt(
    REAL* pa,
    REAL* pb,
    REAL* pc,
    REAL* pd,
    REAL permanent)
{
    ...
    // To save stack space for the MAC, arrays are allocated in
    // exactinit().  Call exactcleanup() to free memory.
