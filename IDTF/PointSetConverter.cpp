...
IFXRESULT PointSetConverter::ConvertPointSet(IFXAuthorPointSet** ppModel)
{
    ...
    if (IFXSUCCESS(result) && allocationDescriptor.m_numPoints > 0 && allocationDescriptor.m_numNormals > 0)
    {
        U32* pPoint = NULL;
    ...
    // coordinate array)
    if (IFXSUCCESS(result) && (allocationDescriptor.m_numTexCoords > 0) && allocationDescriptor.m_numPoints > 0)
    {
        U32 layers = 0;
    ...
    */
    ...
    if (IFXSUCCESS(result) && allocationDescriptor.m_numPoints > 0 && allocationDescriptor.m_numMaterials > 0)
    {
        for (i = 0; i < allocationDescriptor.m_numPoints && IFXSUCCESS(result); ++i)
        {
    ...
    if (IFXSUCCESS(result) && allocationDescriptor.m_numPoints > 0 && allocationDescriptor.m_numDiffuseColors > 0)
    {
        U32* pPoint = NULL;
    ...
    if (IFXSUCCESS(result) && allocationDescriptor.m_numPoints > 0 && allocationDescriptor.m_numSpecularColors > 0)
    {
        U32* pPoint = NULL;
