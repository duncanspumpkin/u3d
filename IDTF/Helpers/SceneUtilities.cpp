...
IFXRESULT SceneUtilities::InitializeScene(U32 profile, F64 scaleFactor)
{
    ...
    {
        result = IFXCreateComponent(CID_IFXCoreServices, IID_IFXCoreServices, (void**)&m_pCoreServicesMain);
    }
    ...
    if (m_pSceneGraph)
    {
        ...
        if (IFXSUCCESS(result))
        {
            result = m_pSceneGraph->GetPalette(IFXSceneGraph::GENERATOR, &m_pGeneratorPalette);
        }
        if (IFXSUCCESS(result))
        {
            result = m_pSceneGraph->GetPalette(IFXSceneGraph::SHADER, &m_pShaderPalette);
        }
    }
...
**/
//------------------------------------------------------------------
IFXRESULT SceneUtilities::WriteSceneToFile(const IFXCHAR* pFileName, IFXExportOptions in_ExportOptions)
{
    IFXRESULT result = IFX_OK;
    ...
    if (pIFXWriteManager)
    {
        ...
        {
            result = pIFXWriteBuffer->QueryInterface(IID_IFXStdio, (void**)&pIFXStdio);
        }
    ...
    U32* pNodeId)
{
    ...
    if (result == IFX_E_CANNOT_FIND || result == IFX_E_PALETTE_NULL_RESOURCE_POINTER)
    {
    ...
    IFXViewResource** ppViewResource)
{
    ...
    if (IFXSUCCESS(result))
    {
        ...
        if (IFX_E_CANNOT_FIND == result)
        {
            ...
            result = IFXCreateComponent(CID_IFXViewResource, IID_IFXViewResource, (void**)&pResource);
...
@return    IFXRESULT         Return status of this method.
*/
IFXRESULT SceneUtilities::CreateGroupNode(const IFXString& rNodeName, IFXNode** ppNode)
{
    IFXRESULT result = IFX_OK;
    IFXNode* pNode = NULL;
    ...
    IFXLightResource** ppLightResource)
{
    ...
    if (IFXSUCCESS(result))
    {
        ...
        if (IFX_E_CANNOT_FIND == result)
        {
            ...
            result = IFXCreateComponent(CID_IFXLightResource, IID_IFXLightResource, (void**)&pResource);
            ...
            if (IFXSUCCESS(result))
            {
                ...
                */
                result = pCompiler->Compile(
                    (IFXString&)rName, pMesh, &pModel, FALSE, &rParams);
            }
    ...
    IFXAuthorPointSetResource** ppModel)
{
    ...
    if (IFXSUCCESS(result))
    {
        result = CreateModelResource(rName, CID_IFXAuthorPointSetResource, modelPriority, &pGenerator);
    }

    if (pGenerator && IFXSUCCESS(result))
    {
        result = pGenerator->QueryInterface(IID_IFXAuthorPointSetResource, (void**)&pPointSetGenerator);
    }
    ...
    IFXAuthorLineSetResource** ppModel)
{
    ...
    if (IFXSUCCESS(result))
    {
        result = CreateModelResource(rName, CID_IFXAuthorLineSetResource, modelPriority, &pGenerator);
    }

    if (pGenerator && IFXSUCCESS(result))
    {
        result = pGenerator->QueryInterface(IID_IFXAuthorLineSetResource, (void**)&pLineSetGenerator);
    }
...
**/
//------------------------------------------------------------------
IFXRESULT SceneUtilities::FindModel(const IFXString& rModelName, IFXModel** ppModel)
{
    IFXRESULT result = IFX_OK;
    IFXDECLARELOCAL(IFXNode, pNode);
    IFXModel* pModel = NULL;
...
@return    IFXRESULT         Return status of this method.
*/
IFXRESULT SceneUtilities::CreateModelResource(const IFXString& rName, IFXREFCID componentId, U32 priority, IFXGenerator** ppGenerator)
{
    IFXRESULT result = IFX_OK;
    ...
    if (IFXSUCCESS(result))
    {
        ...
        if (IFX_E_CANNOT_FIND == result)
        {
            ...
            {
                result = IFXCreateComponent(CID_IFXAuthorCLODResource, IID_IFXGenerator, (void**)&pGenerator);
            }
            else if (CID_IFXAuthorLineSetResource == componentId)
            {
                result = IFXCreateComponent(CID_IFXAuthorLineSetResource, IID_IFXGenerator, (void**)&pGenerator);
            }
            else if (CID_IFXAuthorPointSetResource == componentId)
            {
                result = IFXCreateComponent(CID_IFXAuthorPointSetResource, IID_IFXGenerator, (void**)&pGenerator);
            }
            else
            {
...
**/
//-------------------------------------------------------------------------------------------------
IFXRESULT SceneUtilities::GetMaterialFromShader(IFXShaderLitTexture* pShaderLitTexture, IFXMaterialResource** ppMaterial)
{
    IFXRESULT result = IFX_OK;
    U32 uMaterialID = 0;
    ...
    IFXMaterialResource** ppMaterial)
{
    ...
    if (IFXSUCCESS(result))
    {
        result = IFXCreateComponent(CID_IFXMaterialResource, IID_IFXUnknown, (void**)&pUnknown);
    }
    ...
    IFXMotionResource** ppMotionResource)
{
    ...
    if (IFXSUCCESS(result))
    {
        result = IFXCreateComponent(CID_IFXMotionResource, IID_IFXMotionResource, (void**)&pMotionResource);
    }
