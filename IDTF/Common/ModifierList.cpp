...
IFXRESULT ModifierList::AddModifier(const Modifier* pModifier)
{
    ...
    {
        AnimationModifier& animationModifier = m_animationModifierList.CreateNewElement();
    ...
    {
        BoneWeightModifier& boneWeightModifier = m_boneWeightModifierList.CreateNewElement();
    ...
    {
        CLODModifier& clodModifier = m_clodModifierList.CreateNewElement();
    ...
    {
        SubdivisionModifier& subdivModifier = m_subdivModifierList.CreateNewElement();
    ...
    {
        GlyphModifier& glyphModifier = m_glyphModifierList.CreateNewElement();
